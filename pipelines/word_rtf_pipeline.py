# pipelines/word_rtf_pipeline.py
# Пайплайн для .rtf файлов: Aspose(Java) → COM fallback
...
@PipelineRegistry.register("word_rtf")
class WordRtfPipeline(BasePipeline):
    """Пайплайн для .rtf файлов."""
