# pipelines/word_odt_pipeline.py
# Пайплайн для .odt файлов: Aspose(Java) → COM fallback
...
@PipelineRegistry.register("word_odt")
class WordOdtPipeline(BasePipeline):
    """Пайплайн для .odt файлов."""
