# pipelines/xml_xml_pipeline.py
# Пайплайн для .xml файлов: XML parsing + XPath tree
...
@PipelineRegistry.register("xml_xml")
class XmlXmlPipeline(BasePipeline):
    """Пайплайн для .xml файлов."""
    ...
    def extract(self, file_path: Path) -> Dict:
        ...
        try:
            ...
            logger.error(f"XML extraction error {file_path.name}: {e}")
            result['error'] = str(e)
