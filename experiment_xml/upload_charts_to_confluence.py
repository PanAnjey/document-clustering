#!/usr/bin/env python3
# upload_charts_to_confluence.py - Embed charts as base64 in Confluence page content
import base64
...
if not pie_png.exists() or not bar_png.exists():
    print("ERROR: Chart PNG files not found. Run generate_charts.py first.")
    sys.exit(1)
...
<tbody>
<tr>
<td><strong>В пакетах</strong> (<code>PacketId IS NOT NULL</code>)</td>
<td>379 464</td>
<td><strong>57.29%</strong></td>
</tr>
<tr>
<td>Без пакетов (<code>PacketId IS NULL</code>)</td>
<td>282 851</td>
<td>42.71%</td>
</tr>
<tr>
<td><strong>Итого</strong></td>
<td><strong>662 315</strong></td>
...
<th>В пакетах</th>
<th>Без пакетов</th>
<th>Доля без пакетов</th>
</tr>
</thead>
<tbody>
<tr>
<td>2025 год (полный)</td>
<td>965 035</td>
<td>617 413</td>
...
<td>&mdash;</td>
<td>&mdash;</td>
<td><span style="color: #ff4757; font-weight: bold;">▲ +3.69 п.п.</span></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><strong>Акт приемки выполненных работ КС-2</strong></td>
<td>29 784</td>
<td>12</td>
<td><span style="color: #00ff88; font-weight: bold;">99.96%</span></td>
</tr>
<tr>
<td><strong>Справка о стоимости выполненных работ КС-3</strong></td>
<td>29 729</td>
<td>11</td>
<td><span style="color: #00ff88; font-weight: bold;">99.96%</span></td>
</tr>
<tr>
<td><strong>Акт на взаимозачет</strong></td>
<td>2 115</td>
<td>2</td>
<td><span style="color: #00ff88; font-weight: bold;">99.91%</span></td>
</tr>
<tr>
<td><strong>Корректировочный счет-фактура</strong></td>
<td>2 392</td>
<td>77</td>
<td><span style="color: #00ff88; font-weight: bold;">96.88%</span></td>
</tr>
<tr>
<td><strong>Детализация услуг</strong></td>
<td>1 150</td>
<td>46</td>
<td><span style="color: #00ff88; font-weight: bold;">96.15%</span></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><strong>Акт МХ-3 (возврат)</strong></td>
<td>4 255</td>
<td>50 766</td>
<td><span style="color: #ffd93d; font-weight: bold;">7.73%</span></td>
</tr>
<tr>
<td><strong>Акт МХ-1 (складской)</strong></td>
<td>5 340</td>
<td>34 689</td>
<td><span style="color: #ffd93d; font-weight: bold;">13.34%</span></td>
</tr>
<tr>
<td><strong>Акт сверки</strong></td>
<td>408</td>
<td>6 504</td>
<td><span style="color: #ffd93d; font-weight: bold;">5.90%</span></td>
</tr>
</tbody>
</table>
...
# Output the HTML content to stdout for piping
