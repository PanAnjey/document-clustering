...
Запускает по порядку:
    ...
    2) 2_train.py            — полное обучение EfficientNet-B1 (вход: INPUT_MODE)
...
def _print_config_summary():
    ...
    print("=" * 70)
    print("ПОЛНОЕ ОБУЧЕНИЕ (EfficientNet-B1) — текущие настройки:")
...
def main():
    ...
    _run("Этап 2: обучение EfficientNet-B1", ["2_train.py"])
